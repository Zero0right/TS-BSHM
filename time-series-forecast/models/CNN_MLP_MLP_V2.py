...
# 定义一个CNN块，包含因果卷积，批标准化，激活函数，dropout和残差连接
#init初始化神经网络结构，初始化参数
...
class Model(nn.Module):
    def __init__(
        ...
        self.encoders = nn.Sequential(
            ResidualBlock(
                input_dim=configs.seq_len*configs.enc_in+self.CNN_output_dim,
    ...
    def forward(
        ...
        x_lookback = x
        # zyc CNN
        x_lookback_CNN_features = self.CNN(x_lookback)
